...
class FeedMessageFilter(filters.FilterSet):
    ...
    class Meta:
        model = FeedMessage
        # Corrige los filterset_fields previos del ViewSet, que eran copy-paste
        # de TripViewSet (shape_id/direction_id/...) e inexistentes aquí.
...
class StopTimeUpdateFilter(filters.FilterSet):
    ...
    class Meta:
        ...
        # Corrige los filterset_fields previos (shape_id/direction_id/...),
        # también copy-paste inválido desde TripViewSet.
...
class VehiclePositionFilter(filters.FilterSet):
    ...
    class Meta:
        ...
        # Reemplaza los nombres legacy (vehicle_vehicle_id, vehicle_trip_*) que
        # ya no existen en el modelo actual tras el rename del proto.
        fields = [
            "entity_id",
            "feed_message",
            "trip_trip_id",
...
class ServiceAlertFilter(filters.FilterSet):
    ...
    class Meta:
        model = Alert
        # Corrige los filterset_fields previos (alert_id/route_id/trip_id/...),
        # inexistentes en el modelo Alert actual.
